...
import { m as globalthis_default, n as defineHandlerCallback, o as RouterProvider, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-72y7qmBa.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-8deQ6cB5.mjs").then((n) => n.t),
		import("./start-CbN6eN0a.mjs"),
		import("./empty-plugin-adapters--zZ40bGb.mjs")
	]);
	return {
		routerEntry,
		startEntry,
